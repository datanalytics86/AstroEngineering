export const es = {
  ...
  "chart.wheel.hint": "Toca un planeta, casa, aspecto o ángulo para leer su síntesis.",
  ...
  "modal.orb": "orbe",
  "modal.house_unit": "Síntesis de la casa",
  "modal.ruler_condition": "Condición del regente",
  "modal.angular_connection": "Vínculo con los ángulos",
  "modal.solar_relation": "Relación con el Sol",
  "modal.tone.constructive": "Clima constructivo",
  "modal.tone.challenging": "Clima exigente",
  "modal.tone.transformative": "Clima transformador",
  "modal.tone.latent": "Clima latente",
  "modal.footer": "Valens · Ptolomeo · Lilly · Morin · Rudhyar · Greene · Hand · Brennan · Demetra George",
