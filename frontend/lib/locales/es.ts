export const es = {
  ...
  "chart.ready": "Tus 6 áreas, listas.",
  ...
  "chart.wheel.title": "El mapa (si quieres mirarlo)",
  "chart.wheel.toggle_show": "Ver el mapa",
  "chart.wheel.toggle_hide": "Ocultar el mapa",
  "chart.wheel.hint": "Toca un punto del mapa si quieres una nota más técnica.",
  ...
  "chart.pro.teaser.title": "Cómo se siente este año",
  "chart.pro.teaser.body":
    "Ya viste cómo eres. Pro te dice cómo se siente este año: un resumen en claro, los meses más cargados y lo que más te marca.",
  ...
  "chart.pro.feature.summary": "Quién eres, en tres párrafos",
  "chart.pro.feature.tier1": "Lo que más te marca, en una frase",
  "chart.pro.feature.intensity": "Este año, mes a mes: cuándo apretar y cuándo soltar",
  "chart.pro.feature.transits": "Qué áreas se activan este año",
