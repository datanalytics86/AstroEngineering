export const es = {
  ...
  "nueva.from_pdf": "Vienes del preview PDF. Calcula o abre tu carta para ver el pulso del año — no es la página de inicio.",
  "nueva.from_sample": "Eso era un ejemplo. Ahora calcula tu carta real: seis áreas gratis, Pro cuando quieras el pulso de tu año.",
  ...
  "chart.pro.badge": "Pro",
  "chart.pro.title_unlocked": "Tu año, con más profundidad",
  "chart.pro.teaser.title": "El pulso de tu año",
  ...
  "chart.pro.feature.tier1": "Las piezas que más pesan, con una frase de impacto",
  "chart.pro.feature.intensity": "El pulso de tus 12 meses: cuándo apretar y cuándo soltar",
  "chart.pro.feature.transits": "Qué áreas de vida se activan este año",
  "chart.pro.preview_cta": "Ver un preview de lo Pro",
  "chart.pro.preview_title": "Así se ve Pro",
  "chart.pro.preview_note": "Ejemplo ficticio (Alex Rivera). Tu Pro usa tu cielo.",
  "chart.pro.preview_download": "Descargar PDF ejemplo",
  "chart.pro.preview_unlock": "Desbloquear mi Pro · $2.99",
  ...
  "pay.intent.question": "¿Pagarías $2.99 de verdad?",
  "pay.intent.yes": "Sí — desbloquear",
