...
const CONTENT_SECURITY_POLICY = [
  ...
  "connect-src 'self' https://astroengine.onrender.com https://astroengine-backend.onrender.com https://nominatim.openstreetmap.org https://*.ingest.sentry.io https://*.ingest.us.sentry.io",
