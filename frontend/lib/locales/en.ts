export const en = {
  ...
  "nueva.from_pdf": "You came from the PDF preview. Calculate or open your chart to see the pulse of the year — this is not the home page.",
  "nueva.from_sample": "That was a sample. Now calculate your real chart: six areas free, Pro when you want the pulse of your year.",
  ...
  "chart.pro.preview_cta": "See a Pro preview",
  "chart.pro.preview_title": "This is what Pro looks like",
  "chart.pro.preview_note": "Fictional example (Alex Rivera). Your Pro uses your sky.",
  "chart.pro.preview_download": "Download sample PDF",
  "chart.pro.preview_unlock": "Unlock my Pro · $2.99",
